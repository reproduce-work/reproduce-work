...
\item \textbf{Platform dependence} 
\item \textbf{Code complexity} 
\item \textbf{Lack of independent verification}
...
\noindent\textit{\textbf{Reproduction} of a computational study means running the same computation on the same input data, and then checking if the results are the same. \ldots{}
\textbf{Replication} of a scientific study (computational or other) means repeating a published protocol, respecting its spirit and intentions but varying the technical details. \ldots{} The idea is to change something that everyone believes shouldn’t matter, and see if the scientific conclusions are affected or not. \ldots{}
...
\begin{center}\begin{tabular}{r} \begin{tabular}{lcccccc} \toprule                & \textbf{coef} & \textbf{std err} & \textbf{t} & \textbf{P$> |$t$|$} & \textbf{[0.025} & \textbf{0.975]}  \\ \midrule \textbf{$\alpha$} &       2.1368  &        0.100     &    21.343  &         0.000        &        1.940    &        2.333     \\ \textbf{$\beta$}    &       0.2921  &        0.100     &     2.915  &         0.004        &        0.095    &        0.489     \\ \bottomrule \end{tabular} \\ \hfill {\footnotesize \href{https://example.com}{\texttt{open data} \raisebox{-1mm}{\includegraphics[width=5mm]{../../nbs/img/logo.png}} }} \hspace{-1.5mm}$\;$\end{tabular}\end{center}
